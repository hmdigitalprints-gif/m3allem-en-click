        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-4 text-[var(--text)]">
              Your <span className="text-[var(--accent)]">Invoices.</span>
            </h1>
            <p className="text-[var(--text-muted)] text-lg">View and download your billing history.</p>
          </div>
          <div className="bg-[var(--card-bg)] border border-[var(--border)] px-8 py-4 rounded-3xl flex items-center gap-4 shadow-xl">
            ...
            <div>
              <p className="text-[10px] text-[var(--text-muted)] uppercase tracking-widest font-bold mb-1">Total Spent</p>
              ...
              <tbody className="divide-y divide-[var(--border)]/50">
                {[1, 2, 3, 4, 5]?.map((i) => (
                  <tr key={i} className="hover:bg-[var(--bg)] transition-colors group">
                    ...
                    <td className="p-6 font-bold text-[var(--text)]">Electrical Repair</td>
