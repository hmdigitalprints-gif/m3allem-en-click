...
const categories = ["All", "Tools", "Materials", "Smart Home", "Safety Gear"];
    ...
    <Layout>
      <div className="flex-1 bg-[var(--bg)] min-h-screen relative">
        ...
        <div className="relative z-20 max-w-3xl">
          ...
          >
            EQUIP YOUR <br />
            <span className="text-[var(--accent)]">CRAFT.</span>
          </motion.h1>
          <p className="text-[var(--text-muted)] text-xl max-w-xl mb-8">Get the best tools and materials used by our top-rated artisans, delivered to your doorstep.</p>
        </div>
      </section>
