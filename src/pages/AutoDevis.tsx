      ...
      <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] pb-20">
        <div className="max-w-2xl mx-auto p-6 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold leading-tight text-[var(--text)]">Get an instant price estimate for your project.</h2>
            <p className="text-[var(--text-muted)] text-sm">Our AI analyzes market data across Morocco to give you the most accurate pricing range.</p>
          </div>

          <form onSubmit={handleEstimate} className="space-y-6">
            {/* Service Type */}
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-[var(--text-muted)]/30 uppercase tracking-widest ml-4">Service Category</label>
            ...
            {/* City */}
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-[var(--text-muted)]/30 uppercase tracking-widest ml-4">City</label>
              <div className="relative">
            ...
            {/* Urgency */}
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-[var(--text-muted)]/30 uppercase tracking-widest ml-4">Urgency</label>
                ...
                <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-[32px] p-8 space-y-6 relative overflow-hidden shadow-2xl">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className="text-xl font-bold text-[var(--text-muted)]">MAD</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 bg-[var(--accent)]/10 rounded-2xl border border-[var(--accent)]/20 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-[var(--text)]">{estimate.suggested} MAD</p>
                    </div>
