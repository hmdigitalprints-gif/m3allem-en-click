      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6 md:space-y-8">
          ...
          {loading ? (
            ...
            <div className="hynex-card p-12 text-center flex flex-col items-center justify-center border-dashed border-2">
              ...
              <h3 className="text-xl font-bold text-[var(--text)] mb-2">{t('no_artisans_found', 'No Artisans Found')}</h3>
              <p className="text-[var(--text-muted)] max-w-md">
                {t('no_artisans_desc', 'We couldn\'t find any artisans matching your current filters. Try adjusting your search criteria.')}
              </p>
              <button 
                onClick={resetFilters}
                className="mt-6 px-6 py-2.5 bg-[var(--bg)] text-[var(--text)] font-semibold rounded-full border border-[var(--border)] hover:bg-[var(--hover)] transition-all"
              >
