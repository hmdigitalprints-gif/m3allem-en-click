  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 w-5 h-5 bg-[var(--destructive)] text-[var(--text)] text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-[var(--bg)] shadow-lg">
            {unreadCount}
          </span>
        )}
      </button>
