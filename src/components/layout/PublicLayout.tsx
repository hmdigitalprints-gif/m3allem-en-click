      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg)]/80 backdrop-blur-xl border-b border-[var(--border)]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group cursor-pointer">
            ...
            <span className="text-xl font-bold tracking-tighter text-[var(--text)]">M3allem <span className="text-[var(--accent)]">En Click</span></span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[var(--text-muted)]">
            ...
            <Link to="/become-artisan" className="hover:text-[var(--accent)] transition-colors">Become an Artisan</Link>
            <Link to="/store" className="hover:text-[var(--accent)] transition-colors">Materials Store</Link>
            <Link to="/pricing" className="hover:text-[var(--accent)] transition-colors">Pricing</Link>
          </div>
      ...
      <footer className="py-20 border-t border-[var(--border)] mt-auto bg-[var(--bg)] text-[var(--text)]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            ...
            <div>
              <h5 className="font-bold mb-6 uppercase tracking-widest text-xs opacity-40 text-[var(--text-muted)]">Platform</h5>
            ...
            <div>
              <h5 className="font-bold mb-6 uppercase tracking-widest text-xs opacity-40 text-[var(--text-muted)]">Company</h5>
              <ul className="space-y-4 text-sm text-[var(--text-muted)]">
            ...
            <div>
              <h5 className="font-bold mb-6 uppercase tracking-widest text-xs opacity-40 text-[var(--text-muted)]">Legal</h5>
              <ul className="space-y-4 text-sm text-[var(--text-muted)]">
